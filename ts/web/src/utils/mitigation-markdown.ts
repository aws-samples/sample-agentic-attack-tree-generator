...
/** The minimal mitigation shape this serializer reads (from aggregateMitigations). */
export interface MarkdownMitigation {
  name?: string;
  techniqueId?: string;
  description?: string;
}

export function mitigationToMarkdown(mitigation: MarkdownMitigation | null | undefined): string {
