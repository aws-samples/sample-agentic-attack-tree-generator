...
/**
 * Route "/applications" — TS/Next port of console-ui's pages/ApplicationsPage.jsx.
 *
 * Lists v2 applications with sorting, per-row export (lazy /data fetch), and
 * delete that dispatches to the right endpoint for record vs legacy-folder apps.
 */
...
import type { ApplicationSummary } from '@threatforest/types';
