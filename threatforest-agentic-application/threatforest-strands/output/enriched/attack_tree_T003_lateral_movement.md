...
graph TD
    ...
    E --> F["Exploit container escape vulnerability<br/><small>T1496.A006</small>"]
    ...
    J --> K
    K --> L["Discover HealthLake connections<br/><small>T1049</small>"]
    ...
    O --> P["Query FHIR data repository<br/><small>T1213</small>"]
    O --> Q["Exfiltrate FHIR resources"]
    P --> R["Unauthorized access to patient FHIR data<br/><small>AT1029</small>"]
    Q --> R
...
| Query FHIR data repository | T1213 | Data from Information Reposito... | collection | 0.306 |
...
| Unauthorized access to patient FHIR data | AT1029 | Data from Cloud Database | collection | 0.338 |
...
| Exploit container escape vulnerability | T1496.A006 | Compute Hijacking - ECS | impact | 0.391 |
| Discover HealthLake connections | T1049 | System Network Connections Dis... | discovery | 0.360 |
