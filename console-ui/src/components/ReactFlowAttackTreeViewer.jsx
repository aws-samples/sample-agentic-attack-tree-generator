...
import { ReactFlow, Controls, ReactFlowProvider, applyNodeChanges } from '@xyflow/react';
...
export default function ReactFlowAttackTreeViewer({ attackTree, onNodeClick }) {
