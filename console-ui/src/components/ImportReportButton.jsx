...
import { getImportsInfo, uploadTfReport } from '../api-client';
 ...
 */
export default function ImportReportButton({ onImported }) {
        ...
        <SpaceBetween size="m">
          ...
          {result && result.status === 'merged' && (
            <Alert type="success" header="Merged into existing app">
              Added {result.versions_added.length} new version
