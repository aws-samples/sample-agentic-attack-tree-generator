...
**Generated on:** 2025-11-25 17:12:51
...
- **T001**: Payment Data Breach (19 TTC mappings)
- **T002**: Account Takeover (35 TTC mappings)
- **T003**: Price Manipulation (14 TTC mappings)
- **T004**: DDoS Attack (24 TTC mappings)
- **T005**: Inventory Fraud (20 TTC mappings)
- **T006**: Supply Chain Attack (25 TTC mappings)
- **T007**: Database Backup Exposure (22 TTC mappings)
- **T008**: Admin Panel Compromise (33 TTC mappings)
- **T009**: Payment Gateway Fraud (32 TTC mappings)
- **T010**: Customer Data Exfiltration (23 TTC mappings)
