...
- **T3**: LLM01 Prompt Injection / LLM06 Excessive Agency (12 TTC mappings)
- **T7**: LLM04 Data/Model Poisoning (11 TTC mappings)
- **T9**: LLM04 Data/Model Poisoning (15 TTC mappings)
- **T10**: LLM10 Unbounded Consumption (15 TTC mappings)
- **T13**: LLM03 Supply Chain (16 TTC mappings)
