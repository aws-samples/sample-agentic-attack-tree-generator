...
- Ensure each threat has all required components: source, prerequisites, action, impact, goal, assets"""
        ...
        try:
            ...
            self._create_threats_markdown_file(threats, context_files.get('project_path', '.'))
            
            print(f"✅ Generated {len(threats)} threat statements using AI analysis")
            print(f"📄 Threats saved to generated_threats.md")
            return threats
            ...
            self._create_threats_markdown_file(fallback_threats, context_files.get('project_path', '.'))
            return fallback_threats
    
    def _create_threats_markdown_file(self, threats: List[Dict[str, Any]], project_path: str) -> None:
        """Create a markdown file with generated threat statements"""
        
        markdown_content = f"""# Generated Threat Statements
...
"""
        ...
        # Write to file
        output_path = Path(project_path) / "generated_threats.md"
